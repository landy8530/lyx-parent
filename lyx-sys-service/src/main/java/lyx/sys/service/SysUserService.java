...
import lyx.sys.dao.SysUserDao;
import lyx.sys.facade.SysUserFacade;


/**
 * 内部调用dubbo协议，外部调用rest协议
 * @author landyChris
 *
 */
...
public class SysUserService implements SysUserFacade {
	...
	public JSONObject getById(String id) {
		//get
		//http://localhost:8080/lyx-sys-service/sysUserService/getById/{id}
	...
	public List<JSONObject> getList() throws Exception {
		//post
		//http://localhost:8080/lyx-sys-service/sysUserService/getById/getList
